...
> Neat generate and validate csrf tokens

[![PyPI version](https://badge.fury.io/py/neat-csrf-token.svg)](https://pypi.org/project/neat-csrf-token/)
...
```bash
pip install neat-csrf-token
```

## Quick Start

```python
from neat_csrf_token import token
...
from neat_csrf_token import batch
